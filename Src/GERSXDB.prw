...
MsAguarde({|| RunProc() }, "GeraÁ„o pacote de instalaÁ„o", "Processando tabelas. Aguarde....", .T.)
...
For nTables := 1 To Len(aTables)
	...
	MsAguarde({|| GerSX1(@cSXB,@cSX5) }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "sx1.dbf]. Aguarde....", .T.)
	ProcessMessage()

	MsAguarde({|| GerSX2() }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "sx2.dbf]. Aguarde....", .T.)
	ProcessMessage()
	
	MsAguarde({|| GerSX3(@cSXB,@cSX5,@cSXG) }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "sx3.dbf]. Aguarde....", .T.)
	ProcessMessage()

	MsAguarde({|| GerSX5(cSX5) }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "sx5.dbf]. Aguarde....", .T.)
	ProcessMessage()
	MsAguarde({|| GerSX6() }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "sx6.dbf]. Aguarde....", .T.)
	ProcessMessage()

	MsAguarde({|| GerSIX() }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "six.dbf]. Aguarde....", .T.)
	ProcessMessage()

	MsAguarde({|| GerSX7() }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "sx7.dbf]. Aguarde....", .T.)
	ProcessMessage()

	MsAguarde({|| GerSX9() }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "sx9.dbf]. Aguarde....", .T.)
	ProcessMessage()

	MsAguarde({|| GerSXA() }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "sxa.dbf]. Aguarde....", .T.)
	ProcessMessage()

	MsAguarde({|| GerSXB(cSXB) }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "sxb.dbf]. Aguarde....", .T.)
	ProcessMessage()

	MsAguarde({|| GerSXG(cSXG) }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "sxg.dbf]. Aguarde....", .T.)
	ProcessMessage()

	MsAguarde({|| GerSXV() }, "GeraÁ„o pacote de instalaÁ„o", "Gerando [" + __DIR + "sxv.dbf]. Aguarde....", .T.)
	ProcessMessage()
Next
...
While ! Eof()
	...
	MsAguarde({|| 	FileCopy(__DIR + SX2->X2_CHAVE + "dat.dbf", cFilter) }, "GeraÁ„o pacote de instalaÁ„o",;
...
If File(cFile)
	...
	DbGoTop()
	While ! Eof()
		//Verificacao se o campo x3_F3  est· preenchido 
		if ! Empty(X3_F3) 
